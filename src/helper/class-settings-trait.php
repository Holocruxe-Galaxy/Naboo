...
trait SettingsTrait {
    ...
    public static function get_setup_from_settings() {
                    return ['api-key' => self::get_option('api-key', '') ,
                            ...
                            'forwarding-agent-name-dflt' => self::get_option('forwarding-agent-name-dflt', '') ,
                            'forwarding-agent-last-name-dflt' => self::get_option('forwarding-agent-last-name-dflt', '') ,
                            'pickup-phone-dflt' => self::get_option('pickup-phone-dflt', '') ,
                            'pickup-email-dflt' => self::get_option('pickup-email-dflt', '') ,
                            'pickup-address-dflt' => self::get_option('pickup-address-dflt', '') ,
                            'pickup-address-nbr-dflt' => self::get_option('pickup-address-nbr-dflt', '') ,
                            'pickup-city-dflt' => self::get_option('pickup-city-dflt', '') ,
                            'pickup-state-dflt' => self::get_option('pickup-state-dflt', '') ,
                            'pickup-postalcode-dflt' => self::get_option('pickup-postalcode-dflt', '') ,
                            'pickup-notes-dflt' => self::get_option('pickup-notes-dflt', '') ,
                    ];
    }
