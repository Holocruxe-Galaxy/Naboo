...
/*add_action( 'woocommerce_order_status_changed', ['\Ecomerciar\Pickit\Orders\ProcessNonPickitOrders', 'handle_order_status'], 10, 4);
add_action( 'woocommerce_checkout_update_order_meta', ['\Ecomerciar\Pickit\Orders\ProcessNonPickitOrders', 'process_new_checkout'], 30, 1 );
*/
// --- Cron update Points
